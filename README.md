...
| Resource | Link |
|---|---|
| 🔵 Simulasi Tinkercad | *(isi link simulasi di sini)* |
| 📺 Video Demonstrasi YouTube | *(isi link YouTube di sini)* |
| 📄 Laporan Project (PDF) | `docs/Laporan_Project.pdf` |
...
| Nama | NIM | Peran |
|---|---|---|
| *(Nama 1)* | *(NIM)* | *(Peran, mis. Hardware & Wiring)* |
| *(Nama 2)* | *(NIM)* | *(Peran, mis. Pemrograman Arduino)* |
| *(Nama 3)* | *(NIM)* | *(Peran, mis. Laporan & Dokumentasi)* |
